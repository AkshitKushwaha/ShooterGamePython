            ...
            for x, tile in enumerate(row):
                if tile >= 0:
                    ...
                    if tile >= 0 and tile <= 8:
                        ...
                        player = Soilder('player', x * TILE_SIZE, y * TILE_SIZE, 1.65, 5, 20, 5)
                        health_bar = HealthBar(10, 10, player.health, player.health)
                    elif tile == 16:
                        enemy = Soilder('enemy', x * TILE_SIZE, y * TILE_SIZE, 1.65, 2, 20, 0)
...
while run:
    ...
    if start_game == False:
        ...
        if player.alive:
            ...
            #check if the player has completd the level
            if level_complete:
                start_intro = True
                level += 1
                bg_scroll = 0
